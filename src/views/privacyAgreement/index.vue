<template>
  <div class="page">
    <h1>隐私政策</h1>
    <div>更新日期：<strong>2023/9/4</strong></div>
    <div>生效日期：<strong>2023/9/4</strong></div>
    <h2>导言</h2>
    <p>
      <i>熊猫易租房</i> 是一款由 <i>上海慧霞商贸有限公司</i> （以下简称“我们”）提供的产品。
    ...
    <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>429664046@qq.com</strong> 与我们联系。</p>
    ...
    <ul>
      ...
      <li><strong>审核房源信息</strong>，您在申请房源时，向我们提供的相关个人信息，例如电话号码，学历证明等。</li>
    </ul>
    ...
    <ul>
      ...
      <li
        >目前我们不会跨境传输或存储您的个人信息。将来如需跨境传输或存储的，我们会向您告知信息出境的目的、接收方、安全保证措施和安全风险，并征得您的同意。</li
      >
    </ul>
    ...
    <ul>
      <li
        >当我们的产品或服务发生停止运营的情况时，我们将以推送通知、公告等形式通知您，并在合理期限内删除您的个人信息或进行匿名化处理，法律法规另有规定的除外。</li
      >
    </ul>
